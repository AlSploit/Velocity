...
task.spawn(function()
	local FovChanger, DropDownButton, LayoutOrder = CreateToggle("FovChanger", UtilityTab, Settings.FovChanger.Value, function(CallBack)
	...
	DropDownButton.Activated:Connect(function()
		if FovChangerValue == true then
			FovChanger = CreateSlider("Fov", UtilityTab, Settings.FovChanger.Fov, 120, LayoutOrder + 1, function(Callback)
